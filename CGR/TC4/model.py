...
class Cube:
    def __init__(self, app):
        ...
        #self.texture = self.get_texture(path='textures/SergioAcevedo/volcanic-variations-2-lavamolten.gif')
        self.texture = self.get_texture(path='textures/Test/zach-sharts-img-7687.jpg')
        self.on_init()
